...
|---|---|--:|---|
| **ACCESO** | tutto attivo | **6/8** | `ESITO CONTRO I CRITERI -- REGGE /`, ``d0` NON scappa`, ``d/d0` vicino a 1` |
| **SOLO-SCRITTURA** | `MEM_MOTO = False` | **7/8** | `ESITO CONTRO I CRITERI -- REGGE /`, ``d0` NON scappa` |
| **INTERO-BLOCCO** | `MEM_MOTO_TUTTO = False` | **6/8** | `ESITO CONTRO I CRITERI -- REGGE /`, ``d0` NON scappa`, ``d/d0` vicino a 1` |
