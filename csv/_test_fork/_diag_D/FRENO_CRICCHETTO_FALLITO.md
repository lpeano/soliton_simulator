...
| caso | `x0/LAM` | `LAM` | deriva MISURATA per passo | deriva ATTESA | scarto | esito |
|---|--:|--:|--:|--:|--:|---|
| b1 il freno VERO, `x0 = 10*LAM` | 10 | 0.8000 | **+5.848156e-03** | +6.383076e-03 | 8.4 % | PASS |
| b1 il freno VERO, `x0 = 100*LAM` | 100 | 0.8000 | **+7.107459e-03** | +6.383076e-03 | 11.3 % | *** FAIL *** |
| **b2 IL CASO CHE DEVE FALLIRE: `LAM = 0`** | 10 | 0.0000 | **+2.597463e-05** | +0.000000e+00 | 0.0 % | *** FAIL: deriva SENZA il freno asimmetrico *** |
| **b3 IL CASO CHE DEVE FALLIRE: freno SIMMETRICO** | 10 | 0.8000 | **+1.280199e-06** | +0.000000e+00 | 0.0 % | *** FAIL: deriva SENZA il freno asimmetrico *** |
...
- **(b) il cricchetto: **i criteri NON tornano: si dichiara e non si conclude**.**
