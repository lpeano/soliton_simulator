...
| **G4-bis** | **IL SECONDO BRACCIO: spegnere l'INTERO blocco di `mem_mot`**, spostamento di fase compreso | richiesta di Luca, 2026-09-22 | ▶ **ATTIVATO da `Z109`:** la condizione era *«se `d0` cresce lo stesso»*, e **cresce** *(`1.1607`)*. **Va fatto PRIMA del `CHK3`**: `MEM_MOTO` lascia vivo l'effetto **INDIRETTO**, la proiezione trasversale di `:6016` |
