...
| **G4** | **§4 PROVA DI SPEGNIMENTO: la MEMORIA DEL MOTO** — flag `MEM_MOTO` | GLOBALE-DISEGNO §4 | ▶ **IN CORSO.** ✅ flag *(`60d3128`)* · ✅ **SIGILLO 8/8** *(`d68f3d7`)* · ✅ **CONTROLLO PASSATO: `206` campi identici, `0` diversi, e IL BILANCIO CHIUDE a `4.035e-14`** · ▶ **BRACCIO DI RIFERIMENTO avviato il 2026-09-22 alle 12:48:17, PID 15472**, strumento blob `b9642633`, simulatore `ab685eac`, seme `42`, 600 passi |
