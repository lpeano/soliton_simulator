...
| **G4** | **§4 PROVA DI SPEGNIMENTO: la MEMORIA DEL MOTO** — flag `MEM_MOTO` | GLOBALE-DISEGNO §4 | ▶ **IN CORSO: braccio di SPEGNIMENTO avviato il 2026-09-22 alle 13:59:29, PID 15750.** ✅ flag · ✅ sigillo `8/8` · ✅ controllo `206/0` · ✅ **BRACCIO DI RIFERIMENTO FINITO (2076.7 s): il bilancio CHIUDE a `1.138e-13` e IL MOTORE E' IL FRENO, `+117.41 %` *(`Z108`)*** |
