...
| **G4** | **§4 PROVA DI SPEGNIMENTO: la MEMORIA DEL MOTO** — flag `MEM_MOTO` | GLOBALE-DISEGNO §4 | ▶ **IN CORSO: braccio di SPEGNIMENTO avviato il 2026-09-22 alle 13:59:25, **PID Windows `44824`**.** *(⚠ il `15750` che avevo scritto era il PID della shell MSYS, non del processo Python: `ps -W` stampa il pid di bash nella prima colonna e il **WINPID** nella quarta. Lo stesso vale per il `15472` del braccio di riferimento, che in Windows era `44308`.)* ✅ flag · ✅ sigillo `8/8` · ✅ controllo `206/0` · ✅ **BRACCIO DI RIFERIMENTO FINITO (2076.7 s): il bilancio CHIUDE a `1.138e-13` e IL MOTORE E' IL FRENO, `+117.41 %` *(`Z108`)*** |
