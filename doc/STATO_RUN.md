...
| **G4** | **§4 PROVA DI SPEGNIMENTO: la MEMORIA DEL MOTO** — flag `MEM_MOTO`, `True` di default | GLOBALE-DISEGNO §4 | ▶ **IN CORSO.** ✅ **flag cablato** *(`60d3128`, blob `ab685eac`)* · ✅ **SIGILLO 8/8** *(`3a75256`, blob `940afcc7`): byte-inerte acceso (`T7`, `206/0`) e chirurgico spento*. ⏸ manca il runner con la **traccia COMPLETA** |
